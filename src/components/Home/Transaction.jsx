          ...
          <div className="flex  flex-wrap justify-between items-center gap-3">
            ...
            rounded-[0.375rem] text-[12.5625px] transition-all hover:bg-[#dee2e6]`}
              ...
              <div className="relative">
                <button
                  className={`py-[.5rem] flex gap-1 items-center px-[.75rem]  border border-[#e9ecef]  text-[#081D35] bg-transparent
            rounded-[0.375rem] text-[12.5625px] transition-all hover:bg-[#dee2e6]`}
                >
                  <img src="/assets/filter.png" className="max-w-[13px] w-full h-auto object-contain" alt="" />
                  <img src="/assets/down-arrow (1).png" className="max-w-[13px] w-full h-auto object-contain" alt="" />
                </button>
              </div>
            </div>
          </div>
          ...
          <table className="min-w-full table-auto">
            ...
            <tbody>
              <tr className="hover:bg-gray-100">
                ...
                <td>
                  <div className="flex items-center gap-1">
                    <span className="text-[14.4992px] truncate">0xa23cb9c5...5315a2E27</span>
                    <a href="#">
                      <img src="/assets/copy.png" alt="" />
                    </a>
                  </div>
                ...
                <td>
                  <span className="text-[14.4992px] font-normal">0 ETH</span>
                </td>
                <td className="text-[.875em] text-[#6c757d] showTxnFee">
                  0<b>.</b>00080945
                </td>
              </tr>
              <tr className="hover:bg-gray-100">
