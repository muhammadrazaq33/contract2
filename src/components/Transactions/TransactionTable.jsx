        ...
        <div className="overflow-x-auto">
          <table className="min-w-full table-auto">
            <thead>
              <tr>
                <th
                  className="w-[40px] text-[12.5625px] font-bold py-[.6rem] px-[.5rem]"
                  scope="col"
                >
                  <img
                ...
                <th
                  className="text-[12.5625px] font-bold py-[.6rem] px-[.5rem]"
                  scope="col"
                >
                  Transaction Hash
                </th>
              ...
              <tr className="hover:bg-gray-100">
                ...
                <td>
                  <div className="flex items-center gap-1">
                    <a
                      href=""
                      className="max-w-[6rem] text-[14.4992px] truncate text-[#0784c3]"
                    >
                      0xcb23c4809cb0300880610944974b46ea78d952694590c516818e6cea01ae6f1a
                    </a>
                    <a href="#">
                ...
                <td>
                  <span className="text-[14.4992px] font-normal">
                    7 days ago
                  </span>
                </td>
                <td>
                  <div className="flex items-center gap-1">
                    <a
                      href=""
                      className="text-[14.4992px] truncate text-[#0784c3]"
                    >
                ...
                <td>
                  <div className="flex items-center gap-1">
                    <span className="text-[14.4992px] truncate text-[#0784c3]">
                      0xa23cb9c5...5315a2E27
                    </span>
                    <a href="#">
                      <img src="/assets/copy.png" alt="" />
                    </a>
